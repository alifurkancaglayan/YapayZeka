import tensorflow 
from keras.layers import Conv1D, MaxPooling1D, Flatten, Dense, DroupOut, BatchNormalization
...
model.fit(x_train, y_train, epochs=epochs, bacth_size=batch_size, verbose=1)
